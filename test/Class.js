var Class = (function() {
    ...
    var init = function(class_name, impls) {
        if (isEmpty(class_name)) Console.error.call(this, "ClassName is Null!");
        else instance.className = class_name;
        if (isEmpty(impls)) Console.error.call(this, "Implements of [" + instance.className + "] is Null!");
        else instance.implements = impls;
    };
    ...
    var removeInstance = function(key) {
        if (isNotEmpty(instance_list[key])) instance_list[key] = undefined;
    };
    ...
    Class.prototype.interface = function() {
        ...
        if (isNotEmpty(instance.implements)) {
            ...
            $.each(instance.implements, function(index, value) {
                if (index != instance.getClassName()) impl_methods[index] = value;
            });
            if (!ins) ins = {};
